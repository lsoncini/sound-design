...
public class Level3 extends Board {
    ...
    private final String content =  "KKKKKKKKKK" +
                                    "K...P...PK" +
                                    "K.KKKKKK.K" +
                                    "K.KKKKKK.K" +
                                    "K.KKKKKK.K" +
    ...
    private final String floor = "EEEEEEEEEE" +
                                 "EBBBBBBBBE" +
                                 "EBEEEEEEBE" +
                                 "EBEEEEEEBE" +
                                 "EBEEEEEEBE" +
    ...
    protected Hero createHero() {
        return new Rick(new HeroFighter(3));
    }
    ...
    public Cell getCellForPoint(int x, int y) {
        ...
        switch (character) {
            ...
            case "Y":
                ...
                break;
            case "E":
                returnCell = new GreyGrass();
                break;
            case "B":
                returnCell = new BlueGrass();
                break;
            default:
                returnCell = new Cell();
                break;
